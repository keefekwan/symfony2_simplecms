...
use KK\CMSBundle\Entity\User;
use KK\CMSBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KKCMSBundle:User')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KKCMSBundle:User')->find($id);
