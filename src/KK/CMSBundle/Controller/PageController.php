...
use KK\CMSBundle\Entity\Page;
use KK\CMSBundle\Form\PageType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KKCMSBundle:Page')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KKCMSBundle:Page')->find($id);
